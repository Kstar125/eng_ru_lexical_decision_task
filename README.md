...
- 15 Non-Cognate Russian Words (with a chance of nonce words)
...
To run the script, follow the Getting Started with Create React App guide below and create your own Firebase hosting service & database
to store results.
